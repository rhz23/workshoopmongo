package com.rzaninelli.workshoopmongo.config;

import com.rzaninelli.workshoopmongo.domain.Post;
import com.rzaninelli.workshoopmongo.domain.User;
import com.rzaninelli.workshoopmongo.dto.AuthorDTO;
import com.rzaninelli.workshoopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        User maria = new User(null, "Maria Brown", "margia@gmail.com");
